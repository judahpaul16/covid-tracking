...
do for [ii=1:num_lines] { 
	plot 'data.csv' every ::1::ii u 1:2 w p lw 2 lc 2 title 'NEW INFECTIONS AS OF DAY '.(ii+1), \
	'' every ::1::ii u 1:2 w l lw 5 lc 2 notitle smooth bezier, \
	'' every ::1::ii u 1:3 w p lw 2 lc 3 title 'NEW HOSPITALIZATIONS AS OF DAY '.(ii+1), \
	'' every ::1::ii u 1:3 w l lw 5 lc 3 notitle smooth bezier, \
	'' every ::1::ii u 1:4 w p lw 2 lc 7 title 'NEW DEATHS AS OF DAY '.(ii+1), \
